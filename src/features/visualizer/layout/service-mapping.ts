...
export const RESOURCE_MAPPING: Record<string, { icon: string; color: string }> = {
  ...
  aws_acm_certificate: { icon: 'aws-cloudfront', color: '#DD344C' },
  aws_secretsmanager_secret: { icon: 'aws-iam', color: '#DD344C' },
  aws_secretsmanager_secret_version: { icon: 'aws-iam', color: '#DD344C' },
  ...
  aws_cloudwatch_event_rule: { icon: 'generic-server', color: '#FF9900' },
  aws_cloudwatch_log_group: { icon: 'generic-server', color: '#FF9900' },
  aws_glue_catalog_database: { icon: 'generic-database', color: '#8C4FFF' },
  aws_glue_catalog_table: { icon: 'generic-database', color: '#8C4FFF' },
  aws_glue_crawler: { icon: 'generic-database', color: '#8C4FFF' },
  aws_glue_job: { icon: 'generic-database', color: '#8C4FFF' },
...
const KEYWORD_ICON_MAP: Record<string, string> = {
  ...
  route53: 'aws-route53',
  elb: 'aws-elb',
  glue: 'generic-database',
  athena: 'generic-database',
  stepfunction: 'generic-compute',
};
